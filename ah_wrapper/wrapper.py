...
class AH:
    ...
    def search_products_by_price(self, query: str, target_price: float, tolerance: float = 0.10) -> Dict:
    ...
    def _get_product_price(self, product: Dict) -> Optional[float]:
        if product.get('priceV2') and product['priceV2'].get('now') and product['priceV2']['now'].get('amount'):
